...
function makeStyles(t, topInset = 0) {
  return StyleSheet.create({
    ...
    themeOptionText:  {color: t.text, fontFamily: 'Courier New', fontSize: 12, letterSpacing: 2},
    themeOptionActive:{fontWeight: 'bold'},
    modeRow:          {flexDirection: 'row', alignItems: 'center', marginBottom: 20, marginTop: 16, gap: 12},
    modeBtn:          {color: t.text, fontFamily: 'Courier New', fontSize: 12, letterSpacing: 1},
    modeBtnActive:    {fontWeight: 'bold'},

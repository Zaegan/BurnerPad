...
function makeStyles(t) {
  return StyleSheet.create({
    ...
    body:           {color: t.textBody, fontSize: 17, lineHeight: 26, marginBottom: 16, fontFamily: 'Courier New'},
    warning:        {color: t.errorMuted, fontSize: 15, lineHeight: 22, marginTop: 8, fontFamily: 'Courier New', borderLeftWidth: 2, borderLeftColor: t.errorMuted, paddingLeft: 12},

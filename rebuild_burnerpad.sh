...
APK_OUT="$PROJECT_DIR/android/app/build/outputs/apk/release/app-release.apk"
AAB_OUT="$PROJECT_DIR/android/app/build/outputs/bundle/release/app-release.aab"

echo ""
echo "==> BUILD COMPLETE"
echo "    Unsigned APK : $APK_OUT"
echo "    Unsigned AAB : $AAB_OUT"
echo ""
echo "    Next steps (on signing machine):"
echo "      1. Copy both artifacts to the signing machine:"
echo "           scp tester2@<buildhost>:$APK_OUT ."
echo "           scp tester2@<buildhost>:$AAB_OUT ."
echo ""
echo "      2. Sign both in one go:"
echo "           ./signingceremony_combo.sh app-release.apk app-release.aab"
echo ""
echo "      3. Publish app-release-signed.apk to GitHub releases"
echo "      4. Upload app-release-signed.aab to Play Console closed test track"
